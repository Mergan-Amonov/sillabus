...
async def _create_version(syllabus: Syllabus, user_id: UUID, db: AsyncSession) -> None:
    ...
    snapshot = {
        ...
        "specialization": syllabus.specialization,
        "academic_year": syllabus.academic_year,
        "semester": syllabus.semester,
        "language": syllabus.language,
        "prerequisites": syllabus.prerequisites,
        "lecture_hours": syllabus.lecture_hours,
        "practice_hours": syllabus.practice_hours,
        "lab_hours": syllabus.lab_hours,
        "self_study_hours": syllabus.self_study_hours,
        "grading_policy": syllabus.grading_policy,
        "attendance_policy": syllabus.attendance_policy,
        "passing_grade": syllabus.passing_grade,
        "textbooks": syllabus.textbooks,
        "online_resources": syllabus.online_resources,
